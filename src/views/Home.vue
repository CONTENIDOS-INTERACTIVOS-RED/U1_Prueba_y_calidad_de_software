        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Asegurar la calidad del software es un desafío clave en el desarrollo tecnológico actual. Desde las etapas iniciales de un proyecto, las pruebas permiten verificar que las funcionalidades se comporten como se espera, evitando errores costosos y mejorando la experiencia del usuario. En esta unidad, se explorarán los diferentes tipos de pruebas —unitarias, de integración y de sistema— y las principales técnicas como caja blanca y caja negra, que permiten evaluar de manera precisa el comportamiento del software. Además, se aplicarán estas pruebas en entornos reales con Java y Spring Boot, fortaleciendo habilidades prácticas y analíticas para garantizar la calidad y fiabilidad de las soluciones informáticas.

              p.descripcion.mb-4 #[strong ¡Prepárese para desarrollar software de alta calidad mediante pruebas eficientes y estructuradas!]
